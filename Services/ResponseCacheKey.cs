...
namespace MyCustomUmbracoProject.Services
{
    ...
    {
        public static string Build(string model, string prompt, IReadOnlyList<ChatMessage> history)
        {
        ...
        private static string ComputeHistoryDigest(IReadOnlyList<ChatMessage> history)
        {
